  ...
  if (compact) {
    return (
      <div className="text-[11px] text-muted-foreground/70 leading-relaxed max-w-4xl mx-auto text-center">
        ...
        TradeMoq is a signal routing platform only. We do not provide trading advice or recommendations. 
    ...
    <div className="bg-muted/30 border border-border/50 rounded-lg p-4 text-[11px] text-muted-foreground/80 leading-relaxed">
      <div className="flex items-start gap-2">
        ...
        <div>
          ...
          <p>
            TradeMoq is a signal routing and notification platform that allows users to receive, manage, and forward trading alerts. 
