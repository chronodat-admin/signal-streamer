          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg lg:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0 mb-8 leading-relaxed animate-slide-up" style={{ animationDelay: '200ms' }}>
                Connect TradingView webhooks to SignalPulse. Track, analyze, and share your trading signals with{' '}
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
              No coding required. Connect TradingView to SignalPulse in under a minute.
            </p>
          </div>
                  ...
                  {activeFeature === 0 && (
                    <div className="space-y-4 animate-fade-in">
                      ...
                      <div className="p-4 rounded-lg bg-muted/50 font-mono text-sm break-all">
                        ...
                        <span className="text-primary">signalpulse.io/api/webhook/</span>
                    ...
                    <div className="space-y-4 animate-fade-in">
                      ...
                      <div className="p-4 rounded-lg bg-muted/50">
                        <div className="flex items-center gap-2 text-sm mb-2">
                          ...
                          <span className="font-mono">signalpulse.io/s/</span>
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl text-center relative">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
            Join thousands of traders already using SignalPulse to track and analyze their trading signals.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="md:col-span-2">
              <Link to="/" className="flex items-center gap-3 mb-4">
                ...
                <span className="font-heading text-lg font-bold">SignalPulse</span>
              </Link>
