...
const Privacy = () => {
  ...
  return (
    <>
      <SEO 
        title="Privacy Policy - TradeMoq"
        description="Read TradeMoq's Privacy Policy to understand how we collect, use, and protect your personal information and trading data."
        keywords="privacy policy, data protection, trading platform privacy"
        canonical="https://trademoq.com/privacy"
      />
