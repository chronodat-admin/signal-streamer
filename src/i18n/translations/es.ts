...
export const es: TranslationKeys = {
  ...
  empty: {
    ...
    noStrategiesDescription: 'Crea una estrategia para comenzar a recibir señales',
    noTrades: 'Sin operaciones aún',
    noTradesDescription: 'Las operaciones aparecerán aquí una vez que se procesen las señales',
    noResults: 'Sin resultados',
    noResultsDescription: 'Intenta ajustar tu búsqueda o filtros',
    noOpenTrades: 'Sin operaciones abiertas',
    noOpenTradesDescription: 'Las posiciones abiertas aparecerán aquí',
    noClosedTrades: 'Sin operaciones cerradas',
    noClosedTradesDescription: 'Las operaciones completadas aparecerán aquí',
  },
