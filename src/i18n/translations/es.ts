...
export const es: TranslationKeys = {
  ...
  leaderboard: {
    ...
    subtitle: 'Descubre las mejores estrategias de trading de traders verificados',
    minTrades: 'Mín. operaciones',
    sortBy: 'Ordenar por',
    ranking: 'Puntuación',
    winRate: 'Tasa de Éxito',
    pnl: 'P&L Total',
    ...
    noStrategiesDescription: '¡Sé el primero en crear una estrategia pública con rendimiento verificado!',
    trades: 'operaciones',
    follow: 'Seguir',
    following: 'Siguiendo',
    ...
    filterByExchange: 'Filtrar por Exchange',
  ...
  performance: {
    ...
    winningTrades: 'Ganadoras',
    losingTrades: 'Perdedoras',
    openTrades: 'Abiertas',
    avgPnL: 'P&L Promedio',
    bestTrade: 'Mejor Operación',
    ...
    notEnoughDataDescription: 'Esta estrategia necesita más operaciones para mostrar métricas de rendimiento',
  ...
  subscription: {
    ...
    followDescription: 'Recibe notificaciones cuando esta estrategia publique nuevas señales',
    subscribeDescription: 'Obtén alertas en tiempo real y funciones premium',
    loginRequired: 'Inicia sesión para seguir esta estrategia',
    login: 'Iniciar Sesión',
    followed: 'Ahora sigues esta estrategia',
    unfollowed: 'Has dejado de seguir esta estrategia',
    failedToFollow: 'Error al seguir la estrategia',
    failedToUnfollow: 'Error al dejar de seguir la estrategia',
    manageSubscription: 'Gestionar Suscripción',
    yourSubscriptions: 'Tus Suscripciones',
    noSubscriptions: 'Aún no sigues ninguna estrategia',
    discoverStrategies: 'Descubrir Estrategias',
  },
