...
export const en = {
  ...
  empty: {
    ...
    noStrategiesDescription: 'Create a strategy to start receiving signals',
    noTrades: 'No trades yet',
    noTradesDescription: 'Trades will appear here once signals are processed',
    noResults: 'No results found',
    noResultsDescription: 'Try adjusting your search or filters',
    noOpenTrades: 'No open trades',
    noOpenTradesDescription: 'Open positions will appear here',
    noClosedTrades: 'No closed trades',
    noClosedTradesDescription: 'Completed trades will appear here',
  },
